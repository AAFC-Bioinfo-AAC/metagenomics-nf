...
do
  ...
  fastp -i $i -I $j -o paired_trimmed/${prefix}_trimmed_R1.fastq.gz \ 
	...
	--length_required 100 \ 
	--cut_tail --cut_front --cut_mean_quality 15 \ 
	--qualified_quality_phred 15 cut_window_size 4 \ 
	--detect_adapter_for_pe --report_title="${prefix}" \ 
	--html=${prefix}.html --thread=$NSLOTS
done
